function [net, info] = resnext_imagenet(varargin)
% RESNEXT_IMAGENET Evaluate imported PyTorch models on ImageNet val set
% This function is based on the mcn cnn_imagenet.m script by Andrea Vedaldi
%
% Copyright (C) 2017 Samuel Albanie 
% All rights reserved.

  opts.model = 'resnext_50_32x4d-pt-mcn' ;
  opts.gpus = 3 ;
  opts.batchSize = 256 ;
  opts.continue = 1 ;
